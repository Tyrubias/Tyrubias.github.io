...
function AboutMe () {
  return (
    <div className='grid grid-cols-page gap-x-8 grid-rows-none items-center justify-between h-screen'>
      <picture>
      ...
      <div>
        <h1 className='font-extrabold text-5xl my-8 subpixel-antialiased'>Hi, I'm Victor Song</h1>
